...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {menuOpen && (<div className="fixed inset-0 z-50 flex"><div className="w-72 bg-topbar h-full overflow-y-auto p-4"><div className="flex items-center justify-between mb-8"><img src={unipinLogo} alt="UniPin" className="h-8" /><button onClick={() => setMenuOpen(false)} className="text-foreground text-2xl font-bold">✕</button></div></div><div className="flex-1 bg-black/60" onClick={() => setMenuOpen(false)} /></div>)}
      ...
      <footer className="bg-topbar">
        ...
        <div className="border-t border-border">
          <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6">
            ...
            <p className="text-xs text-muted-foreground text-center sm:text-left mb-1">WhatsApp: <span className="text-primary">0853-1111-1010</span></p>
            <p className="text-xs text-muted-foreground text-center sm:text-left mb-4">To submit suggestions, complaints or concerns, consumers can contact: <span className="text-primary">+62 859-5959-3535</span></p>
