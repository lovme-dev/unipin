      ...
      <footer className="bg-topbar">
        ...
        <div className="border-t border-border">
          <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6">
            ...
            <p className="text-xs text-muted-foreground text-center sm:text-left mb-1">WhatsApp: <a href="https://wa.me/14502322003" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">+1 450-232-2003</a></p>
            <p className="text-xs text-muted-foreground text-center sm:text-left mb-4">To submit suggestions, complaints or concerns, consumers can contact: <a href="https://wa.me/14502322003" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">+1 450-232-2003</a></p>
