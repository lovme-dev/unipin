      ...
      <div className="mt-6 bg-topbar px-4 py-8">
        ...
        <div className="border-t border-border pt-4 mt-4">
          ...
          <p className="text-center text-xs text-muted-foreground mb-4">
            {t.suggestionsComplaint} <a href="https://wa.me/14502322003" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">+1 450-232-2003</a>
          </p>
